...
```{r}
#one way of doing it with characters 
...
for( B in Folds){
  ...
  #recreate our models
  modelX <- glmer(diagnosis ~ rangeRE + (1|uniqueness) + (1|study), data = Bear, family= "binomial", REML=F) #can't we just use all our data to create the model? 
