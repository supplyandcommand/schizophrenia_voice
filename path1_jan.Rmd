...
rocCurve <- roc(response = Bear_scaled$diagnosis, 
                predictor = as.numeric(range_pred))
pROC::auc(rocCurve)
ci(rocCurve)
...
m1 <- "diagnosis ~ range + Gender + (1|uniqueness) + (1|triangle)"
m2 <- "diagnosis ~ sd + Gender + (1|uniqueness) + (1|triangle)"
m3 <- "diagnosis ~ mean + Gender + (1|uniqueness) + (1|triangle)"
m4 <- "diagnosis ~ median + Gender + (1|uniqueness) + (1|triangle)"
m5 <- "diagnosis ~ iqr + Gender + (1|uniqueness) + (1|triangle)"
m6 <- "diagnosis ~ mean_abs + Gender + (1|uniqueness) + (1|triangle)"
m7 <- "diagnosis ~ coef_var + Gender + (1|uniqueness) + (1|triangle)"
