...
mean_single_error_pred %>%
  ...
  labs(title = "Single predictor model performances", 
       subtitle = "comparison of sensitivity and specificity across predictors",
...
mean_single_error_pred %>%
  ...
  theme_bw() +
  labs(title = "Single predictor model performances", 
       subtitle = "comparison of PPV and NPV across predictors",
       color = "random effects?",
       x = "diagnosis ~ X") +
  theme(legend.position ="bottom",
        panel.grid.major.x = element_blank())
...
#### PLOTTING
```{r}
mean_par_error_pred <- mean_par_error %>%
  mutate(predictor = case_when(str_detect(model, "range") ~ "range",
                               str_detect(model, "sd") ~ "sd",
                               str_detect(model, "mean") ~ "mean",
                               str_detect(model, "median") ~ "median",
